...
let what = User.createUser("Riya", "Bhansali", "what.up@yahoo.com", "letmein", 20);
let hello = User.createUser("Jack", "Kempler", "hello.world@yahoo.com", "letmein", 20);
users.push(max);
users.push(adam);
users.push(what);
users.push(hello);
...
exports.loginUser = function (req, res) {
  ...
  // Find the user with the matching email address and password
